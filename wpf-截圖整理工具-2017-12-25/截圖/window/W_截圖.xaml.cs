...
namespace 截圖 {
    ...
    public partial class W_截圖 : Window {
        ...
        public W_截圖(MainWindow m) {
            ...
            //程式最大化
            this.Width = System.Windows.Forms.Cursor.Clip.Size.Width;
            this.Height = System.Windows.Forms.Cursor.Clip.Size.Height;
        ...
        public void fun_確認儲存(String type) {
            ...
            System.Drawing.Bitmap img = KiCut(bimg, (int)t.Left, (int)t.Top, (int)t.Width, (int)t.Height);
        ...
        public static System.Drawing.Bitmap KiCut(System.Drawing.Bitmap b, int StartX, int StartY, int iWidth, int iHeight) {
            if (b == null) {
                return null;
            }
            ...
            try {
                ...
                g.DrawImage(b, new System.Drawing.Rectangle(0, 0, iWidth, iHeight), new System.Drawing.Rectangle(StartX, StartY, iWidth, iHeight), System.Drawing.GraphicsUnit.Pixel);
                g.Dispose();
